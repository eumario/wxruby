...
#define  SWIGTYPE_p_wxCalendarEvent swig_types[0] 
...
swig_class cWxCalendarEvent;
static void free_wxCalendarEvent(wxCalendarEvent *);
/***********************************************************************
 * director.swg
 *
...
#ifdef wxDEBUG
    printf("CalendarEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
_wrap_wxCalendarEvent_GetDate(int argc, VALUE *argv, VALUE self) {
    ...
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxCalendarEvent, 1);
    {
...
static VALUE
_wrap_wxCalendarEvent_GetWeekDay(int argc, VALUE *argv, VALUE self) {
    wxCalendarEvent *arg1 = (wxCalendarEvent *) 0 ;
    ...
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxCalendarEvent, 1);
    result = ((wxCalendarEvent const *)arg1)->GetWeekDay();
...
static VALUE
_wrap_wxCalendarEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxCalendarEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxCalendarEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxCalendarEvent(int argc, VALUE *argv, VALUE self) {
    wxCalendarEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxCalendarEvent *)new wxCalendarEvent();
...
static void
free_wxCalendarEvent(wxCalendarEvent *arg1) {
    //delete arg1;
}
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxCalendarEvent(void) {
...
mWxCalendarEvent = mWxruby2;
    ...
    cWxCalendarEvent.klass = rb_define_class_under(mWxCalendarEvent, "CalendarEvent", rb_cObject);
    SWIG_TypeClientData(SWIGTYPE_p_wxCalendarEvent, (void *) &cWxCalendarEvent);
    rb_define_alloc_func(cWxCalendarEvent.klass, _wrap_wxCalendarEvent_allocate);
    rb_define_method(cWxCalendarEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxCalendarEvent), -1);
    rb_define_method(cWxCalendarEvent.klass, "get_date", VALUEFUNC(_wrap_wxCalendarEvent_GetDate), -1);
    rb_define_method(cWxCalendarEvent.klass, "get_week_day", VALUEFUNC(_wrap_wxCalendarEvent_GetWeekDay), -1);
    cWxCalendarEvent.mark = 0;
    cWxCalendarEvent.destroy = (void (*)(void *)) free_wxCalendarEvent;
}
