...
static void free_wxChoice(wxChoice *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_wxChoice_SetColumns(int argc, VALUE *argv, VALUE self) {
    wxChoice *arg1 = (wxChoice *) 0 ;
    int arg2 = (int) 1 ;
...
static swig_type_info _swigt__p_wxChoice[] = {{"_p_wxChoice", 0, "wxChoice *", 0},{"_p_wxChoice"},{0}};
