...
#define SWIGTYPE_p_wxStaticLine swig_types[5]
...
#ifdef wxDEBUG
    printf("StaticLine.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("StaticLine.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxStaticLine;

static VALUE
_wrap_new_wxStaticLine__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *result;
...
static VALUE
_wrap_new_wxStaticLine__SWIG_1(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_new_wxStaticLine__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxWindow *arg1 = (wxWindow *) 0 ;
    wxWindowID arg2 ;
    wxPoint *arg3 = 0 ;
    wxSize *arg4 = 0 ;
    ...
    SWIG_ConvertPtr(argv[3], (void **) &arg4, SWIGTYPE_p_wxSize, 1); if (arg4 == NULL) rb_raise(rb_eTypeError, "null reference");
    arg5 = NUM2LONG(argv[4]);
    result = (wxStaticLine *)new wxStaticLine(arg1,arg2,(wxPoint const &)*arg3,(wxSize const &)*arg4,arg5);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_new_wxStaticLine__SWIG_3(int argc, VALUE *argv, VALUE self) {
    wxWindow *arg1 = (wxWindow *) 0 ;
    wxWindowID arg2 ;
    wxPoint *arg3 = 0 ;
    wxSize *arg4 = 0 ;
    ...
    SWIG_ConvertPtr(argv[2], (void **) &arg3, SWIGTYPE_p_wxPoint, 1); if (arg3 == NULL) rb_raise(rb_eTypeError, "null reference");
    SWIG_ConvertPtr(argv[3], (void **) &arg4, SWIGTYPE_p_wxSize, 1); if (arg4 == NULL) rb_raise(rb_eTypeError, "null reference");
    result = (wxStaticLine *)new wxStaticLine(arg1,arg2,(wxPoint const &)*arg3,(wxSize const &)*arg4);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_new_wxStaticLine__SWIG_4(int argc, VALUE *argv, VALUE self) {
    wxWindow *arg1 = (wxWindow *) 0 ;
    wxWindowID arg2 ;
    wxPoint *arg3 = 0 ;
    wxStaticLine *result;
    ...
    arg2 = NUM2INT(argv[1]);
    SWIG_ConvertPtr(argv[2], (void **) &arg3, SWIGTYPE_p_wxPoint, 1); if (arg3 == NULL) rb_raise(rb_eTypeError, "null reference");
    result = (wxStaticLine *)new wxStaticLine(arg1,arg2,(wxPoint const &)*arg3);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxStaticLine_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxStaticLine_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxStaticLine);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxStaticLine__SWIG_5(int argc, VALUE *argv, VALUE self) {
    wxWindow *arg1 = (wxWindow *) 0 ;
    wxWindowID arg2 ;
    wxStaticLine *result;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxWindow, 1);
    arg2 = NUM2INT(argv[1]);
    result = (wxStaticLine *)new wxStaticLine(arg1,arg2);
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxStaticLine(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[6];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxStaticLine__SWIG_0(nargs, args, self);
    }
    if (argc == 2) {
        int _v;
        {
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxStaticLine__SWIG_5(nargs, args, self);
            }
        }
    }
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_new_wxStaticLine__SWIG_4(nargs, args, self);
                }
            }
        }
    }
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        return _wrap_new_wxStaticLine__SWIG_3(nargs, args, self);
                    }
                }
            }
        }
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            return _wrap_new_wxStaticLine__SWIG_2(nargs, args, self);
                        }
                    }
                }
            }
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_new_wxStaticLine__SWIG_1(nargs, args, self);
                            }
                        }
                    }
                }
    ...
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxStaticLine'");
    return Qnil;
}


static VALUE
_wrap_wxStaticLine_Create__SWIG_0(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 6) || (argc > 6))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 6)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxStaticLine, 1);
...
static VALUE
_wrap_wxStaticLine_Create__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxWindowID arg3 ;
    wxPoint *arg4 = 0 ;
...
static VALUE
_wrap_wxStaticLine_Create__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxWindowID arg3 ;
    wxPoint *arg4 = 0 ;
...
static VALUE
_wrap_wxStaticLine_Create__SWIG_3(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxWindowID arg3 ;
    wxPoint *arg4 = 0 ;
...
static VALUE
_wrap_wxStaticLine_Create__SWIG_4(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxWindowID arg3 ;
    bool result;
...
static VALUE _wrap_wxStaticLine_Create(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[8];
    int ii;
    ...
    if (argc == 3) {
        ...
        {
            void *ptr;
            _v = (NIL_P(argv[0]) || (TYPE(argv[0]) == T_DATA && SWIG_ConvertPtr(argv[0], &ptr, SWIGTYPE_p_wxStaticLine, 0) != -1)) ? 1 : 0;
        }
        if (_v) {
            {
                void *ptr;
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_wxStaticLine_Create__SWIG_4(nargs, args, self);
                }
            }
        }
    }
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        return _wrap_wxStaticLine_Create__SWIG_3(nargs, args, self);
                    }
                }
            }
        }
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            return _wrap_wxStaticLine_Create__SWIG_2(nargs, args, self);
                        }
                    }
                }
            }
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_wxStaticLine_Create__SWIG_1(nargs, args, self);
                            }
                        }
                    }
                }
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                ...
                                if (_v) {
                                    return _wrap_wxStaticLine_Create__SWIG_0(nargs, args, self);
                                }
                            }
                        }
                    }
    ...
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxStaticLine_Create'");
    return Qnil;
}


static VALUE
_wrap_wxStaticLine_IsVertical(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    bool result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxStaticLine_GetDefaultSize(int argc, VALUE *argv, VALUE self) {
    wxStaticLine *arg1 = (wxStaticLine *) 0 ;
    int result;
    VALUE vresult = Qnil;
    ...
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxStaticLine, 1);
    result = (int)(arg1)->GetDefaultSize();
...
static void
free_wxStaticLine(wxStaticLine *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxStaticLine = {"_p_wxStaticLine", "wxStaticLine *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxStaticLine(void) {
...
mWxStaticLine = mWxruby2;
    ...
    Init_wxControl();
    //extern swig_class cWxControl;
    cWxStaticLine.klass = rb_define_class_under(mWxStaticLine, "StaticLine", cWxControl.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxStaticLine, (void *) &cWxStaticLine);
    rb_define_alloc_func(cWxStaticLine.klass, _wrap_wxStaticLine_allocate);
    rb_define_method(cWxStaticLine.klass, "initialize", VALUEFUNC(_wrap_new_wxStaticLine), -1);
    rb_define_method(cWxStaticLine.klass, "create", VALUEFUNC(_wrap_wxStaticLine_Create), -1);
    rb_define_method(cWxStaticLine.klass, "is_vertical", VALUEFUNC(_wrap_wxStaticLine_IsVertical), -1);
    rb_define_method(cWxStaticLine.klass, "get_default_size", VALUEFUNC(_wrap_wxStaticLine_GetDefaultSize), -1);
    cWxStaticLine.mark = 0;
    cWxStaticLine.destroy = (void (*)(void *)) free_wxStaticLine;
}
