...
SwigDirector_wxControl::SwigDirector_wxControl(VALUE self) : Swig::Director(self) {
    
}



SwigDirector_wxControl::~SwigDirector_wxControl() {
}
...
_wrap_new_wxControl(int argc, VALUE *argv, VALUE self) {
    ...
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    arg1 = self;
    char *classname = "WxControl::WxControl";
