...
#define SWIGTYPE_p_wxStaticBox swig_types[2]
#define SWIGTYPE_p_wxStaticBoxSizer swig_types[3]
...
static swig_type_info _swigt__p_wxStaticBoxSizer = {"_p_wxStaticBoxSizer", "wxStaticBoxSizer *", 0, 0, 0};
