...
#define  SWIGTYPE_p_wxTreeEvent swig_types[0] 
#define  SWIGTYPE_p_WXTYPE swig_types[1] 
#define  SWIGTYPE_p_wxTreeItemId swig_types[2] 
...
static void free_wxTreeEvent(wxTreeEvent *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_new_wxTreeEvent(int argc, VALUE *argv, VALUE self) {
