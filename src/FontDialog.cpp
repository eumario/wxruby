...
#define SWIGTYPE_p_wxFontData swig_types[3]
#define SWIGTYPE_p_wxFontDialog swig_types[4]
...
#ifdef wxDEBUG
    printf("FontDialog.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("FontDialog.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxFontDialog;

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
static VALUE
_wrap_wxFontDialog_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxFontDialog_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxFontDialog);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_wxFontDialog_Create__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_wxFontDialog_Create__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxFontDialog *arg1 = (wxFontDialog *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxFontData *arg3 = 0 ;
    bool result;
...
static VALUE _wrap_wxFontDialog_Create(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[4];
    int ii;
    ...
    if (argc == 2) {
        ...
        {
            void *ptr;
            _v = (NIL_P(argv[0]) || (TYPE(argv[0]) == T_DATA && SWIG_ConvertPtr(argv[0], &ptr, SWIGTYPE_p_wxFontDialog, 0) != -1)) ? 1 : 0;
        }
        if (_v) {
            {
                void *ptr;
            ...
            if (_v) {
                return _wrap_wxFontDialog_Create__SWIG_0(nargs, args, self);
            }
        }
    }
    if ((argc >= 2) && (argc <= 3)) {
    ...
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxFontDialog_Create'");
    return Qnil;
}


static void
free_wxFontDialog(wxFontDialog *arg1) {
    delete arg1;
}
static VALUE
_wrap_wxFontDialog_GetFontData__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxFontDialog *arg1 = (wxFontDialog *) 0 ;
    wxFontData *result;
    VALUE vresult = Qnil;
    ...
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxFontDialog, 1);
    {
        wxFontData const &_result_ref = ((wxFontDialog const *)arg1)->GetFontData();
        result = (wxFontData *) &_result_ref;
    }
    
    vresult = SWIG_NewPointerObj((void *) result, SWIGTYPE_p_wxFontData,0);
    return vresult;
}


static VALUE
_wrap_wxFontDialog_GetFontData__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxFontDialog *arg1 = (wxFontDialog *) 0 ;
    wxFontData *result;
    VALUE vresult = Qnil;
...
static VALUE _wrap_wxFontDialog_GetFontData(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 1) {
        ...
        if (_v) {
            return _wrap_wxFontDialog_GetFontData__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 1) {
        int _v;
        ...
        if (_v) {
            return _wrap_wxFontDialog_GetFontData__SWIG_0(nargs, args, self);
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxFontDialog_GetFontData'");
    return Qnil;
}


static VALUE
_wrap_wxFontDialog_ShowModal(int argc, VALUE *argv, VALUE self) {
    wxFontDialog *arg1 = (wxFontDialog *) 0 ;
    int result;
    VALUE vresult = Qnil;
...
static swig_type_info _swigt__p_wxFontDialog = {"_p_wxFontDialog", "wxFontDialog *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxFontDialog(void) {
...
mWxFontDialog = mWxruby2;
    ...
    Init_wxDialog();
    //extern swig_class cWxDialog;
    cWxFontDialog.klass = rb_define_class_under(mWxFontDialog, "FontDialog", cWxDialog.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxFontDialog, (void *) &cWxFontDialog);
    rb_define_alloc_func(cWxFontDialog.klass, _wrap_wxFontDialog_allocate);
    rb_define_method(cWxFontDialog.klass, "initialize", VALUEFUNC(_wrap_new_wxFontDialog), -1);
    rb_define_method(cWxFontDialog.klass, "create", VALUEFUNC(_wrap_wxFontDialog_Create), -1);
    rb_define_method(cWxFontDialog.klass, "get_font_data", VALUEFUNC(_wrap_wxFontDialog_GetFontData), -1);
    rb_define_method(cWxFontDialog.klass, "show_modal", VALUEFUNC(_wrap_wxFontDialog_ShowModal), -1);
    cWxFontDialog.mark = 0;
    cWxFontDialog.destroy = (void (*)(void *)) free_wxFontDialog;
}
