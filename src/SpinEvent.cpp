...
#define SWIGTYPE_p_wxSpinEvent swig_types[3]
...
#ifdef wxDEBUG
    printf("SpinEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("SpinEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxSpinEvent;

static VALUE
_wrap_new_wxSpinEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    int arg2 ;
    wxSpinEvent *result;
...
static VALUE
_wrap_new_wxSpinEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    wxSpinEvent *result;
    ...
    arg1 = NUM2INT(argv[0]);
    result = (wxSpinEvent *)new wxSpinEvent(arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxSpinEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxSpinEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxSpinEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxSpinEvent__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxSpinEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxSpinEvent *)new wxSpinEvent();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxSpinEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxSpinEvent__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxSpinEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxSpinEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxSpinEvent'");
    return Qnil;
}


static VALUE
_wrap_wxSpinEvent_GetPosition(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxSpinEvent, 1);
...
static VALUE
_wrap_wxSpinEvent_SetPosition(int argc, VALUE *argv, VALUE self) {
    wxSpinEvent *arg1 = (wxSpinEvent *) 0 ;
    int arg2 ;
...
static void
free_wxSpinEvent(wxSpinEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxSpinEvent = {"_p_wxSpinEvent", "wxSpinEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxSpinEvent(void) {
...
mWxSpinEvent = mWxruby2;
    ...
    Init_wxNotifyEvent();
    //extern swig_class cWxNotifyEvent;
    cWxSpinEvent.klass = rb_define_class_under(mWxSpinEvent, "SpinEvent", cWxNotifyEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxSpinEvent, (void *) &cWxSpinEvent);
    rb_define_alloc_func(cWxSpinEvent.klass, _wrap_wxSpinEvent_allocate);
    rb_define_method(cWxSpinEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxSpinEvent), -1);
    rb_define_method(cWxSpinEvent.klass, "get_position", VALUEFUNC(_wrap_wxSpinEvent_GetPosition), -1);
    rb_define_method(cWxSpinEvent.klass, "set_position", VALUEFUNC(_wrap_wxSpinEvent_SetPosition), -1);
    cWxSpinEvent.mark = 0;
    cWxSpinEvent.destroy = (void (*)(void *)) free_wxSpinEvent;
}
