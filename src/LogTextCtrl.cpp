...
#define  SWIGTYPE_p_wxLogTextCtrl swig_types[0] 
#define  SWIGTYPE_p_wxTextCtrl swig_types[1] 
static swig_type_info *swig_types[3];

/* -------- TYPES TABLE (END) -------- */

#define SWIG_init    Init_wxLogTextCtrl
#define SWIG_name    "WxLogTextCtrl"

static VALUE mWxLogTextCtrl;
...
extern swig_class cWxLog;
swig_class cWxLogTextCtrl;
static void free_wxLogTextCtrl(wxLogTextCtrl *);
/***********************************************************************
 * director.swg
 *
...
#ifdef wxDEBUG
    printf("LogTextCtrl.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("LogTextCtrl.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
static VALUE
_wrap_wxLogTextCtrl_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxLogTextCtrl_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxLogTextCtrl);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxLogTextCtrl(int argc, VALUE *argv, VALUE self) {
...
static void
free_wxLogTextCtrl(wxLogTextCtrl *arg1) {
    //delete arg1;
}
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxLogTextCtrl(void) {
...
mWxLogTextCtrl = mWxruby2;
    ...
    Init_wxLog();
    //extern swig_class cWxLog;
    cWxLogTextCtrl.klass = rb_define_class_under(mWxLogTextCtrl, "LogTextCtrl", cWxLog.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxLogTextCtrl, (void *) &cWxLogTextCtrl);
    rb_define_alloc_func(cWxLogTextCtrl.klass, _wrap_wxLogTextCtrl_allocate);
    rb_define_method(cWxLogTextCtrl.klass, "initialize", VALUEFUNC(_wrap_new_wxLogTextCtrl), -1);
    cWxLogTextCtrl.mark = 0;
    cWxLogTextCtrl.destroy = (void (*)(void *)) free_wxLogTextCtrl;
}
