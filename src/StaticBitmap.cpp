...
#define  SWIGTYPE_p_wxStaticBitmap swig_types[3] 
...
static void free_wxStaticBitmap(wxStaticBitmap *);
/***********************************************************************
 * director.swg
 *
...
#include "src/StaticBitmap.h"

SwigDirector_wxStaticBitmap::SwigDirector_wxStaticBitmap(VALUE self, bool disown): wxStaticBitmap(), Swig::Director(self, disown) {
    
}



SwigDirector_wxStaticBitmap::SwigDirector_wxStaticBitmap(VALUE self, wxWindow *parent, wxWindowID id, wxBitmap const &label, wxPoint const &pos, wxSize const &size, long style, wxString const &name, bool disown): wxStaticBitmap(parent, id, label, pos, size, style, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxStaticBitmap(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxStaticBitmap *)new SwigDirector_wxStaticBitmap(arg1,arg2,arg3,(wxBitmap const &)*arg4,(wxPoint const &)*arg5,(wxSize const &)*arg6,arg7,(wxString const &)*arg8,false);
...
static VALUE
_wrap_wxStaticBitmap_Create(int argc, VALUE *argv, VALUE self) {
