...
#define  SWIGTYPE_p_wxStaticText swig_types[1] 
...
static void free_wxStaticText(wxStaticText *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxStaticText::SwigDirector_wxStaticText(VALUE self, wxWindow *parent, wxWindowID id, wxString const &label, wxPoint const &pos, wxSize const &size, long style, wxString const &name, bool disown): wxStaticText(parent, id, label, pos, size, style, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxStaticText(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    long arg7 = (long) 0 ;
    wxString const &arg8_defvalue = "staticText" ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxStaticText *)new SwigDirector_wxStaticText(arg1,arg2,arg3,(wxString const &)*arg4,(wxPoint const &)*arg5,(wxSize const &)*arg6,arg7,(wxString const &)*arg8,false);
...
static VALUE
_wrap_wxStaticText_Create(int argc, VALUE *argv, VALUE self) {
