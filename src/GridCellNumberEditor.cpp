...
#define  SWIGTYPE_p_wxGridCellNumberEditor swig_types[0] 
...
static void free_wxGridCellNumberEditor(wxGridCellNumberEditor *);
...
static VALUE
_wrap_new_wxGridCellNumberEditor(int argc, VALUE *argv, VALUE self) {
    int arg1 = (int) -1 ;
    int arg2 = (int) -1 ;
