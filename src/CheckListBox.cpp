...
static void free_wxCheckListBox(wxCheckListBox *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxCheckListBox::SwigDirector_wxCheckListBox(VALUE self, wxWindow *parent, wxWindowID id, wxPoint const &pos, wxSize const &size, int n, wxString const choices[], long style, wxValidator const &validator, wxString const &name, bool disown): wxCheckListBox(parent, id, pos, size, n, choices, style, validator, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxCheckListBox(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxCheckListBox *)new SwigDirector_wxCheckListBox(arg1,arg2,arg3,(wxPoint const &)*arg4,(wxSize const &)*arg5,arg6,(wxString const (*))arg7,arg8,(wxValidator const &)*arg9,(wxString const &)*arg10,false);
...
static VALUE
_wrap_wxCheckListBox_Check(int argc, VALUE *argv, VALUE self) {
