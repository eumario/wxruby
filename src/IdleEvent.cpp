...
#define SWIGTYPE_p_wxIdleEvent swig_types[2]
...
static VALUE
_wrap_wxIdleEvent_RequestMore__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_wxIdleEvent_RequestMore__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxIdleEvent *arg1 = (wxIdleEvent *) 0 ;
...
static VALUE _wrap_wxIdleEvent_RequestMore(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[3];
    int ii;
    ...
    if (argc == 1) {
        ...
        {
            void *ptr;
            _v = (NIL_P(argv[0]) || (TYPE(argv[0]) == T_DATA && SWIG_ConvertPtr(argv[0], &ptr, SWIGTYPE_p_wxIdleEvent, 0) != -1)) ? 1 : 0;
        }
        if (_v) {
            return _wrap_wxIdleEvent_RequestMore__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_wxIdleEvent_RequestMore__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxIdleEvent_RequestMore'");
    return Qnil;
}
...
static swig_type_info _swigt__p_wxIdleEvent = {"_p_wxIdleEvent", "wxIdleEvent *", 0, 0, 0};
