...
mWxRubyConstants = mWx;
    ...
    rb_define_const(mWxRubyConstants,"DEFAULT", INT2NUM(wxDEFAULT));
    rb_define_const(mWxRubyConstants,"DECORATIVE", INT2NUM(wxDECORATIVE));
    rb_define_const(mWxRubyConstants,"ROMAN", INT2NUM(wxROMAN));
    rb_define_const(mWxRubyConstants,"SCRIPT", INT2NUM(wxSCRIPT));
    rb_define_const(mWxRubyConstants,"SWISS", INT2NUM(wxSWISS));
    rb_define_const(mWxRubyConstants,"MODERN", INT2NUM(wxMODERN));
    rb_define_const(mWxRubyConstants,"TELETYPE", INT2NUM(wxTELETYPE));
    rb_define_const(mWxRubyConstants,"VARIABLE", INT2NUM(wxVARIABLE));
    rb_define_const(mWxRubyConstants,"FIXED", INT2NUM(wxFIXED));
    rb_define_const(mWxRubyConstants,"NORMAL", INT2NUM(wxNORMAL));
    rb_define_const(mWxRubyConstants,"LIGHT", INT2NUM(wxLIGHT));
    rb_define_const(mWxRubyConstants,"BOLD", INT2NUM(wxBOLD));
    rb_define_const(mWxRubyConstants,"ITALIC", INT2NUM(wxITALIC));
    rb_define_const(mWxRubyConstants,"SLANT", INT2NUM(wxSLANT));
    ...
    rb_define_const(mWxRubyConstants,"STIPPLE_MASK_OPAQUE", INT2NUM(wxSTIPPLE_MASK_OPAQUE));
    rb_define_const(mWxRubyConstants,"STIPPLE_MASK", INT2NUM(wxSTIPPLE_MASK));
    rb_define_const(mWxRubyConstants,"STIPPLE", INT2NUM(wxSTIPPLE));
    rb_define_const(mWxRubyConstants,"BDIAGONAL_HATCH", INT2NUM(wxBDIAGONAL_HATCH));
    rb_define_const(mWxRubyConstants,"CROSSDIAG_HATCH", INT2NUM(wxCROSSDIAG_HATCH));
    rb_define_const(mWxRubyConstants,"FDIAGONAL_HATCH", INT2NUM(wxFDIAGONAL_HATCH));
    rb_define_const(mWxRubyConstants,"CROSS_HATCH", INT2NUM(wxCROSS_HATCH));
    rb_define_const(mWxRubyConstants,"HORIZONTAL_HATCH", INT2NUM(wxHORIZONTAL_HATCH));
    rb_define_const(mWxRubyConstants,"VERTICAL_HATCH", INT2NUM(wxVERTICAL_HATCH));
    rb_define_const(mWxRubyConstants,"JOIN_BEVEL", INT2NUM(wxJOIN_BEVEL));
    rb_define_const(mWxRubyConstants,"JOIN_MITER", INT2NUM(wxJOIN_MITER));
    rb_define_const(mWxRubyConstants,"JOIN_ROUND", INT2NUM(wxJOIN_ROUND));
    rb_define_const(mWxRubyConstants,"CAP_ROUND", INT2NUM(wxCAP_ROUND));
    rb_define_const(mWxRubyConstants,"CAP_PROJECTING", INT2NUM(wxCAP_PROJECTING));
    rb_define_const(mWxRubyConstants,"CAP_BUTT", INT2NUM(wxCAP_BUTT));
