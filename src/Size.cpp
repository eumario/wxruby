...
#define SWIG_init    Init_wxSize
#define SWIG_name    "WxSize"

static VALUE mWxSize;
...
static VALUE wxSize_x(wxSize *self){
        wxSize *me = self;

        if (me != NULL) return INT2NUM(me->x);
        else return Qnil;
    }
static VALUE wxSize_y(wxSize *self){
        wxSize *me=self;
...
#ifdef wxDEBUG
    printf("Size.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
static VALUE
_wrap_wxSize_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxSize_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxSize);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxSize__SWIG_1(int argc, VALUE *argv, VALUE self) {
    int arg1 ;
    int arg2 ;
    wxSize *result;
...
static VALUE _wrap_new_wxSize(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxSize__SWIG_0(nargs, args, self);
    }
    if (argc == 2) {
        int _v;
        {
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxSize__SWIG_1(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxSize'");
    return Qnil;
}


static VALUE
_wrap_wxSize_GetWidth(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxSize, 1);
...
static VALUE
_wrap_wxSize_GetHeight(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    int result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxSize_Set(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    int arg2 ;
    int arg3 ;
...
static VALUE
_wrap_wxSize_SetHeight(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    int arg2 ;
...
static VALUE
_wrap_wxSize_SetWidth(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    int arg2 ;
...
static VALUE
_wrap_wxSize_x(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    VALUE result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxSize_y(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = (wxSize *) 0 ;
    VALUE result;
    VALUE vresult = Qnil;
...
extern "C"
#endif
SWIGEXPORT void Init_wxSize(void) {
...
mWxSize = mWxruby2;
    ...
    cWxSize.klass = rb_define_class_under(mWxSize, "Size", rb_cObject);
    SWIG_TypeClientData(SWIGTYPE_p_wxSize, (void *) &cWxSize);
    rb_define_alloc_func(cWxSize.klass, _wrap_wxSize_allocate);
    rb_define_method(cWxSize.klass, "initialize", VALUEFUNC(_wrap_new_wxSize), -1);
    rb_define_method(cWxSize.klass, "get_width", VALUEFUNC(_wrap_wxSize_GetWidth), -1);
    rb_define_method(cWxSize.klass, "get_height", VALUEFUNC(_wrap_wxSize_GetHeight), -1);
    rb_define_method(cWxSize.klass, "set", VALUEFUNC(_wrap_wxSize_Set), -1);
    rb_define_method(cWxSize.klass, "set_height", VALUEFUNC(_wrap_wxSize_SetHeight), -1);
    rb_define_method(cWxSize.klass, "set_width", VALUEFUNC(_wrap_wxSize_SetWidth), -1);
    rb_define_method(cWxSize.klass, "x", VALUEFUNC(_wrap_wxSize_x), -1);
    rb_define_method(cWxSize.klass, "y", VALUEFUNC(_wrap_wxSize_y), -1);
    cWxSize.mark = 0;
    cWxSize.destroy = (void (*)(void *)) free_wxSize;
}
