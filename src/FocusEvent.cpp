...
#define SWIGTYPE_p_wxFocusEvent swig_types[3]
...
#ifdef wxDEBUG
    printf("FocusEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("FocusEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxFocusEvent;

static VALUE
_wrap_new_wxFocusEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    WXTYPE arg1 ;
    int arg2 ;
    wxFocusEvent *result;
...
static VALUE
_wrap_new_wxFocusEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    WXTYPE arg1 ;
    wxFocusEvent *result;
    ...
    result = (wxFocusEvent *)new wxFocusEvent(arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxFocusEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxFocusEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxFocusEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxFocusEvent__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxFocusEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxFocusEvent *)new wxFocusEvent();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxFocusEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxFocusEvent__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxFocusEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxFocusEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxFocusEvent'");
    return Qnil;
}


static void
free_wxFocusEvent(wxFocusEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxFocusEvent = {"_p_wxFocusEvent", "wxFocusEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxFocusEvent(void) {
...
mWxFocusEvent = mWxruby2;
    ...
    Init_wxEvent();
    //extern swig_class cWxEvent;
    cWxFocusEvent.klass = rb_define_class_under(mWxFocusEvent, "FocusEvent", cWxEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxFocusEvent, (void *) &cWxFocusEvent);
    rb_define_alloc_func(cWxFocusEvent.klass, _wrap_wxFocusEvent_allocate);
    rb_define_method(cWxFocusEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxFocusEvent), -1);
    cWxFocusEvent.mark = 0;
    cWxFocusEvent.destroy = (void (*)(void *)) free_wxFocusEvent;
}
