...
#define SWIGTYPE_p_wxPaintDC swig_types[2]
...
SwigDirector_wxPaintDC::SwigDirector_wxPaintDC(VALUE self, wxWindow *window): wxPaintDC(window), Swig::Director(self) {
    
}



SwigDirector_wxPaintDC::~SwigDirector_wxPaintDC() {
}

extern swig_class cWxWindowDC;
swig_class cWxPaintDC;
...
#else
    static VALUE
    _wrap_wxPaintDC_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxPaintDC);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
_wrap_new_wxPaintDC(int argc, VALUE *argv, VALUE self) {
    ...
    char *classname = "WxPaintDC::WxPaintDC";
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxPaintDC *)new SwigDirector_wxPaintDC(arg1,arg2);
...
extern "C"
#endif
SWIGEXPORT void Init_wxPaintDC(void) {
...
mWxPaintDC = mWxruby2;
    ...
    Init_wxWindowDC();
    //extern swig_class cWxWindowDC;
    cWxPaintDC.klass = rb_define_class_under(mWxPaintDC, "PaintDC", cWxWindowDC.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxPaintDC, (void *) &cWxPaintDC);
    rb_define_alloc_func(cWxPaintDC.klass, _wrap_wxPaintDC_allocate);
    rb_define_method(cWxPaintDC.klass, "initialize", VALUEFUNC(_wrap_new_wxPaintDC), -1);
    cWxPaintDC.mark = 0;
    cWxPaintDC.destroy = (void (*)(void *)) free_wxPaintDC;
}
