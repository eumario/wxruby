...
#define  SWIGTYPE_p_wxToolTip swig_types[0] 
...
static void free_wxToolTip(wxToolTip *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxToolTip::SwigDirector_wxToolTip(VALUE self, wxString const &tip, bool disown): wxToolTip(tip), Swig::Director(self, disown) {
...
_wrap_new_wxToolTip(int argc, VALUE *argv, VALUE self) {
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxToolTip *)new SwigDirector_wxToolTip(arg1,(wxString const &)*arg2,false);
