...
#define  SWIGTYPE_p_wxPoint swig_types[0] 
...
swig_class cWxPoint;
static void free_wxPoint(wxPoint *);
/***********************************************************************
 * director.swg
 *
...
#define MUTEX_INIT(var) pthread_mutex_t var = PTHREAD_MUTEX_INITIALIZER 
  ...
  class Director {
    ...
    printf("Point.cpp" " new Director %p\n", this);
    fflush(stdout);
...
static VALUE
_wrap_wxPoint_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxPoint_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxPoint);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxPoint__SWIG_1(int argc, VALUE *argv, VALUE self) {
    int arg1 ;
    int arg2 ;
    wxPoint *result;
...
static VALUE _wrap_new_wxPoint(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxPoint__SWIG_0(nargs, args, self);
    }
    if (argc == 2) {
        int _v;
        {
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxPoint__SWIG_1(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxPoint'");
    return Qnil;
}
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxPoint(void) {
...
mWxPoint = mWx;
    ...
    cWxPoint.klass = rb_define_class_under(mWxPoint, "Point", rb_cObject);
