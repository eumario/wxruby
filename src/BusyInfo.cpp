...
#define SWIGTYPE_p_wxBusyInfo swig_types[2]
...
#define SWIG_init    Init_wxBusyInfo
#define SWIG_name    "WxBusyInfo"

static VALUE mWxBusyInfo;
...
static void wxBusyInfo_busy__SWIG_0(char const *msg,wxWindow *parent=NULL){
    if (rb_block_given_p())
    {
...
#ifdef wxDEBUG
    printf("BusyInfo.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("BusyInfo.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
SwigDirector_wxBusyInfo::SwigDirector_wxBusyInfo(VALUE self, wxString const &msg, wxWindow *parent): wxBusyInfo(msg, parent), Swig::Director(self) {
    
}



SwigDirector_wxBusyInfo::~SwigDirector_wxBusyInfo() {
}

swig_class cWxBusyInfo;

static void
free_wxBusyInfo(wxBusyInfo *arg1) {
    Swig::Director* director = (Swig::Director*)(SwigDirector_wxBusyInfo*)arg1;
#ifdef wxDEBUG
    printf("BusyInfo.cpp" " Checking %p\n", director);
#endif
...
static VALUE
_wrap_wxBusyInfo_busy__SWIG_0(int argc, VALUE *argv, VALUE self) {
    char *arg1 = (char *) 0 ;
    ...
    wxBusyInfo_busy__SWIG_0((char const *)arg1,arg2);
...
static VALUE
_wrap_wxBusyInfo_busy__SWIG_1(int argc, VALUE *argv, VALUE self) {
    char *arg1 = (char *) 0 ;
    
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    arg1 = StringValuePtr(argv[0]);
    wxBusyInfo_busy__SWIG_0((char const *)arg1);
    
    return Qnil;
}


static VALUE _wrap_wxBusyInfo_busy(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 1) {
        ...
        if (_v) {
            return _wrap_wxBusyInfo_busy__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_wxBusyInfo_busy__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxBusyInfo_busy'");
    return Qnil;
}


static VALUE
_wrap_disown_wxBusyInfo(int argc, VALUE *argv, VALUE self) {
    wxBusyInfo *arg1 = (wxBusyInfo *) 0 ;
    
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxBusyInfo, 1);
    {
...
extern "C"
#endif
SWIGEXPORT void Init_wxBusyInfo(void) {
...
mWxBusyInfo = mWxruby2;
    ...
    rb_define_module_function(mWxBusyInfo, "disown_wxBusyInfo", VALUEFUNC(_wrap_disown_wxBusyInfo), -1);
    
    cWxBusyInfo.klass = rb_define_class_under(mWxBusyInfo, "BusyInfo", rb_cObject);
    SWIG_TypeClientData(SWIGTYPE_p_wxBusyInfo, (void *) &cWxBusyInfo);
    rb_undef_alloc_func(cWxBusyInfo.klass);
    rb_define_singleton_method(cWxBusyInfo.klass, "busy", VALUEFUNC(_wrap_wxBusyInfo_busy), -1);
    cWxBusyInfo.mark = 0;
    cWxBusyInfo.destroy = (void (*)(void *)) free_wxBusyInfo;
}
