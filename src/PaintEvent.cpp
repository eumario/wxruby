...
#define SWIGTYPE_p_wxPaintEvent swig_types[2]
...
#ifdef wxDEBUG
    printf("PaintEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
SwigDirector_wxPaintEvent::SwigDirector_wxPaintEvent(VALUE self, int id): wxPaintEvent(id), Swig::Director(self) {
    
}



SwigDirector_wxPaintEvent::~SwigDirector_wxPaintEvent() {
}

extern swig_class cWxEvent;
swig_class cWxPaintEvent;

static VALUE
_wrap_new_wxPaintEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    int arg2 ;
    wxPaintEvent *result;
    ...
    arg1 = self;
    arg2 = NUM2INT(argv[0]);
    char *classname = "WxPaintEvent::WxPaintEvent";
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxPaintEvent *)new SwigDirector_wxPaintEvent(arg1,arg2);
...
static VALUE
_wrap_wxPaintEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxPaintEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxPaintEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxPaintEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    wxPaintEvent *result;
    ...
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxPaintEvent *)new SwigDirector_wxPaintEvent(arg1);
        
    } else {
        result = (wxPaintEvent *)new wxPaintEvent();
...
static VALUE _wrap_new_wxPaintEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[3];
    int ii;
    ...
    if (argc == 1) {
        ...
        _v = (argv[0] != T_NONE);
        if (_v) {
            return _wrap_new_wxPaintEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxPaintEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxPaintEvent'");
    return Qnil;
}
...
static swig_type_info _swigt__p_wxPaintEvent = {"_p_wxPaintEvent", "wxPaintEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxPaintEvent(void) {
...
mWxPaintEvent = mWxruby2;
    ...
    Init_wxEvent();
    //extern swig_class cWxEvent;
    cWxPaintEvent.klass = rb_define_class_under(mWxPaintEvent, "PaintEvent", cWxEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxPaintEvent, (void *) &cWxPaintEvent);
    rb_define_alloc_func(cWxPaintEvent.klass, _wrap_wxPaintEvent_allocate);
    rb_define_method(cWxPaintEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxPaintEvent), -1);
    cWxPaintEvent.mark = 0;
    cWxPaintEvent.destroy = (void (*)(void *)) free_wxPaintEvent;
}
