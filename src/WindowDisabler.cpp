...
#define  SWIGTYPE_p_wxWindowDisabler swig_types[1] 
...
void wxWindowDisabler_disable(wxWindow *parent){
    if (rb_block_given_p())
    {
...
static void free_wxWindowDisabler(wxWindowDisabler *);
/***********************************************************************
 * director.swg
 *
...
free_wxWindowDisabler(wxWindowDisabler *arg1) {
    Swig::Director* director = (Swig::Director*)(SwigDirector_wxWindowDisabler*)arg1;
#ifdef wxDEBUG
    printf("WindowDisabler.cpp" " Checking %p\n", director);
#endif
...
static VALUE
_wrap_wxWindowDisabler_disable(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_disown_wxWindowDisabler(int argc, VALUE *argv, VALUE self) {
    wxWindowDisabler *arg1 = (wxWindowDisabler *) 0 ;
    
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxWindowDisabler, 1);
    {
...
mWxWindowDisabler = mWxruby2;
    ...
    rb_define_module_function(mWxWindowDisabler, "disown_wxWindowDisabler", VALUEFUNC(_wrap_disown_wxWindowDisabler), -1);
