...
#define SWIGTYPE_p_wxTipProvider swig_types[3]
...
#ifdef wxDEBUG
    printf("TipProvider.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("TipProvider.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
SwigDirector_wxTipProvider::SwigDirector_wxTipProvider(VALUE self, size_t currentTip): wxTipProvider(currentTip), Swig::Director(self) {
    
}



swig_class cWxTipProvider;
...
static VALUE
_wrap_wxTipProvider_PreprocessTip(int argc, VALUE *argv, VALUE self) {
    wxTipProvider *arg1 = (wxTipProvider *) 0 ;
    wxString *arg2 = 0 ;
    wxString result;
...
static VALUE
_wrap_wxTipProvider_GetCurrentTip(int argc, VALUE *argv, VALUE self) {
    wxTipProvider *arg1 = (wxTipProvider *) 0 ;
    size_t result;
    VALUE vresult = Qnil;
    ...
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxTipProvider, 1);
    result = ((wxTipProvider const *)arg1)->GetCurrentTip();
...
static void
free_wxTipProvider(wxTipProvider *arg1) {
    Swig::Director* director = (Swig::Director*)(SwigDirector_wxTipProvider*)arg1;
#ifdef wxDEBUG
    printf("TipProvider.cpp" " Checking %p\n", director);
#endif
...
static VALUE
_wrap_disown_wxTipProvider(int argc, VALUE *argv, VALUE self) {
    wxTipProvider *arg1 = (wxTipProvider *) 0 ;
    
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxTipProvider, 1);
    {
...
static VALUE
_wrap_wxCreateFileTipProvider(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    size_t arg2 ;
    ...
    vresult = SWIG_NewPointerObj((void *) result, SWIGTYPE_p_wxTipProvider,0);
    return vresult;
}


static VALUE
_wrap_wxShowTip__SWIG_0(int argc, VALUE *argv, VALUE self) {
    ...
    SWIG_ConvertPtr(argv[1], (void **) &arg2, SWIGTYPE_p_wxTipProvider, 1);
    arg3 = RTEST(argv[2]);
...
static VALUE
_wrap_wxShowTip__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxWindow *arg1 = (wxWindow *) 0 ;
    wxTipProvider *arg2 = (wxTipProvider *) 0 ;
    bool result;
    VALUE vresult = Qnil;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxWindow, 1);
    SWIG_ConvertPtr(argv[1], (void **) &arg2, SWIGTYPE_p_wxTipProvider, 1);
    result = (bool)wxShowTip(arg1,arg2);
...
static VALUE _wrap_wxShowTip(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[3];
    int ii;
    ...
    if (argc == 2) {
        ...
        if (_v) {
            {
                void *ptr;
                _v = (NIL_P(argv[1]) || (TYPE(argv[1]) == T_DATA && SWIG_ConvertPtr(argv[1], &ptr, SWIGTYPE_p_wxTipProvider, 0) != -1)) ? 1 : 0;
            }
            if (_v) {
                return _wrap_wxShowTip__SWIG_1(nargs, args, self);
            }
        }
    }
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_wxShowTip__SWIG_0(nargs, args, self);
                }
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxShowTip'");
    return Qnil;
}
...
static swig_cast_info _swigc__p_wxTipProvider[] = {  {&_swigt__p_wxTipProvider, 0, 0, 0},{0, 0, 0, 0}};
...
extern "C"
#endif
SWIGEXPORT void Init_wxTipProvider(void) {
...
mWxTipProvider = mWxruby2;
    ...
    rb_define_module_function(mWxTipProvider, "disown_wxTipProvider", VALUEFUNC(_wrap_disown_wxTipProvider), -1);
    
    cWxTipProvider.klass = rb_define_class_under(mWxTipProvider, "TipProvider", rb_cObject);
    SWIG_TypeClientData(SWIGTYPE_p_wxTipProvider, (void *) &cWxTipProvider);
    rb_undef_alloc_func(cWxTipProvider.klass);
    rb_define_method(cWxTipProvider.klass, "get_tip", VALUEFUNC(_wrap_wxTipProvider_GetTip), -1);
    rb_define_method(cWxTipProvider.klass, "preprocess_tip", VALUEFUNC(_wrap_wxTipProvider_PreprocessTip), -1);
    rb_define_method(cWxTipProvider.klass, "get_current_tip", VALUEFUNC(_wrap_wxTipProvider_GetCurrentTip), -1);
    cWxTipProvider.mark = 0;
    cWxTipProvider.destroy = (void (*)(void *)) free_wxTipProvider;
    rb_define_module_function(mWxTipProvider, "create_file_tip_provider", VALUEFUNC(_wrap_wxCreateFileTipProvider), -1);
    rb_define_module_function(mWxTipProvider, "show_tip", VALUEFUNC(_wrap_wxShowTip), -1);
}
