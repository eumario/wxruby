...
public:
    SwigDirector_wxWindow(VALUE self);
    SwigDirector_wxWindow(VALUE self, wxWindow *parent, wxWindowID id, wxPoint const &pos = wxDefaultPosition, wxSize const &size = wxDefaultSize, long style = 0, wxString const &name = wxPanelNameStr);
