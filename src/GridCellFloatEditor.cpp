...
#define  SWIGTYPE_p_wxGridCellFloatEditor swig_types[0] 
...
static void free_wxGridCellFloatEditor(wxGridCellFloatEditor *);
...
static VALUE
_wrap_new_wxGridCellFloatEditor(int argc, VALUE *argv, VALUE self) {
    int arg1 = (int) -1 ;
    int arg2 = (int) -1 ;
