...
#define SWIGTYPE_p_wxGridCellFloatEditor swig_types[3]
...
swig_class cWxGridCellFloatEditor;

static VALUE
_wrap_new_wxGridCellFloatEditor__SWIG_0(int argc, VALUE *argv, VALUE self) {
    int arg1 ;
    int arg2 ;
...
static VALUE
_wrap_new_wxGridCellFloatEditor__SWIG_1(int argc, VALUE *argv, VALUE self) {
    int arg1 ;
    wxGridCellFloatEditor *result;
    ...
    arg1 = NUM2INT(argv[0]);
    result = (wxGridCellFloatEditor *)new wxGridCellFloatEditor(arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxGridCellFloatEditor_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxGridCellFloatEditor_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxGridCellFloatEditor);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxGridCellFloatEditor__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxGridCellFloatEditor *result;
...
static VALUE _wrap_new_wxGridCellFloatEditor(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxGridCellFloatEditor__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxGridCellFloatEditor__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxGridCellFloatEditor__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxGridCellFloatEditor'");
    return Qnil;
}


static VALUE
_wrap_wxGridCellFloatEditor_SetParameters(int argc, VALUE *argv, VALUE self) {
...
static void
free_wxGridCellFloatEditor(wxGridCellFloatEditor *arg1) {
    delete arg1;
}
...
extern "C"
#endif
SWIGEXPORT void Init_wxGridCellFloatEditor(void) {
...
initialized = true;
    ...
    SWIG_InitRuntime();
mWxGridCellFloatEditor = mWxruby2;
    ...
    //extern swig_class cWxGridCellTextEditor;
    cWxGridCellFloatEditor.klass = rb_define_class_under(mWxGridCellFloatEditor, "GridCellFloatEditor", cWxGridCellTextEditor.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxGridCellFloatEditor, (void *) &cWxGridCellFloatEditor);
    rb_define_alloc_func(cWxGridCellFloatEditor.klass, _wrap_wxGridCellFloatEditor_allocate);
    rb_define_method(cWxGridCellFloatEditor.klass, "initialize", VALUEFUNC(_wrap_new_wxGridCellFloatEditor), -1);
    rb_define_method(cWxGridCellFloatEditor.klass, "set_parameters", VALUEFUNC(_wrap_wxGridCellFloatEditor_SetParameters), -1);
    cWxGridCellFloatEditor.mark = 0;
    cWxGridCellFloatEditor.destroy = (void (*)(void *)) free_wxGridCellFloatEditor;
}
