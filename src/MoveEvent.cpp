...
#define SWIGTYPE_p_wxMoveEvent swig_types[2]
...
#ifdef wxDEBUG
    printf("MoveEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("MoveEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxMoveEvent;

static VALUE
_wrap_new_wxMoveEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxPoint *arg1 = 0 ;
    int arg2 ;
    wxMoveEvent *result;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxPoint, 1); if (arg1 == NULL) rb_raise(rb_eTypeError, "null reference");
    arg2 = NUM2INT(argv[1]);
...
static VALUE
_wrap_wxMoveEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxMoveEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxMoveEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxMoveEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxPoint *arg1 = 0 ;
    wxMoveEvent *result;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxPoint, 1); if (arg1 == NULL) rb_raise(rb_eTypeError, "null reference");
    result = (wxMoveEvent *)new wxMoveEvent((wxPoint const &)*arg1);
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxMoveEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 1) {
        ...
        {
            void *ptr;
            _v = (NIL_P(argv[0]) || (TYPE(argv[0]) == T_DATA && SWIG_ConvertPtr(argv[0], &ptr, SWIGTYPE_p_wxPoint, 0) != -1)) ? 1 : 0;
        }
        if (_v) {
            return _wrap_new_wxMoveEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxMoveEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxMoveEvent'");
    return Qnil;
}


static VALUE
_wrap_wxMoveEvent_GetPosition(int argc, VALUE *argv, VALUE self) {
    ...
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxMoveEvent, 1);
...
static void
free_wxMoveEvent(wxMoveEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxMoveEvent = {"_p_wxMoveEvent", "wxMoveEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxMoveEvent(void) {
...
mWxMoveEvent = mWxruby2;
    ...
    Init_wxEvent();
    //extern swig_class cWxEvent;
    cWxMoveEvent.klass = rb_define_class_under(mWxMoveEvent, "MoveEvent", cWxEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxMoveEvent, (void *) &cWxMoveEvent);
    rb_define_alloc_func(cWxMoveEvent.klass, _wrap_wxMoveEvent_allocate);
    rb_define_method(cWxMoveEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxMoveEvent), -1);
    rb_define_method(cWxMoveEvent.klass, "get_position", VALUEFUNC(_wrap_wxMoveEvent_GetPosition), -1);
    cWxMoveEvent.mark = 0;
    cWxMoveEvent.destroy = (void (*)(void *)) free_wxMoveEvent;
}
