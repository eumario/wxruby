...
#define  SWIGTYPE_p_wxMoveEvent swig_types[0] 
...
static void free_wxMoveEvent(wxMoveEvent *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_new_wxMoveEvent(int argc, VALUE *argv, VALUE self) {
    wxPoint *arg1 = 0 ;
    int arg2 = (int) 0 ;
    wxMoveEvent *result;
