...
#define  SWIGTYPE_p_wxClientDC swig_types[1] 
static swig_type_info *swig_types[3];

/* -------- TYPES TABLE (END) -------- */

#define SWIG_init    Init_wxClientDC
#define SWIG_name    "WxClientDC"

static VALUE alive = Qnil;

static VALUE mWxClientDC;
   extern VALUE mWx;
...
extern swig_class cWxWindowDC;
swig_class cWxClientDC;
static void free_wxClientDC(wxClientDC *);
/***********************************************************************
 * director.swg
 *
...
#define MUTEX_INIT(var) pthread_mutex_t var = PTHREAD_MUTEX_INITIALIZER 
  ...
  class Director {
    ...
    printf("ClientDC.cpp" " new Director %p\n", this);
    fflush(stdout);
    ...
    printf("ClientDC.cpp" " ~Director %p\n", this);
    fflush(stdout);
    GcMarkDeleted(this);
      }
...
#include "src/ClientDC.h"

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
static VALUE
_wrap_wxClientDC_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxClientDC_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxClientDC);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxClientDC(int argc, VALUE *argv, VALUE self) {
...
static void
free_wxClientDC(wxClientDC *arg1) {
    //delete arg1;
}
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxClientDC(void) {
...
mWxClientDC = mWx;
    ...
    Init_wxWindowDC();
    //extern swig_class cWxWindowDC;
    cWxClientDC.klass = rb_define_class_under(mWxClientDC, "ClientDC", cWxWindowDC.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxClientDC, (void *) &cWxClientDC);
    rb_define_alloc_func(cWxClientDC.klass, _wrap_wxClientDC_allocate);
    rb_define_method(cWxClientDC.klass, "initialize", VALUEFUNC(_wrap_new_wxClientDC), -1);
    cWxClientDC.mark = 0;
    cWxClientDC.destroy = (void (*)(void *)) free_wxClientDC;
}
