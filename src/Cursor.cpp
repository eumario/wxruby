...
#define SWIG_init    Init_wxCursor
#define SWIG_name    "WxCursor"

static VALUE mWxCursor;
...
#ifdef wxDEBUG
    printf("Cursor.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
static VALUE
_wrap_wxCursor_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxCursor_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxCursor);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
_wrap_new_wxCursor__SWIG_3(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxCursor, 1); if (arg1 == NULL) rb_raise(rb_eTypeError, "null reference");
    result = (wxCursor *)new wxCursor((wxCursor const &)*arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE _wrap_new_wxCursor(int nargs, VALUE *args, VALUE self) {
    ...
    if (argc == 0) {
        return _wrap_new_wxCursor__SWIG_0(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
    ...
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxCursor'");
    return Qnil;
}


static void
free_wxCursor(wxCursor *arg1) {
    delete arg1;
}
static VALUE
_wrap_wxCursor_Ok(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxCursor, 1);
    result = (bool)((wxCursor const *)arg1)->Ok();
...
extern "C"
#endif
SWIGEXPORT void Init_wxCursor(void) {
...
mWxCursor = mWxruby2;
    ...
    Init_wxBitmap();
    //extern swig_class cWxBitmap;
    cWxCursor.klass = rb_define_class_under(mWxCursor, "Cursor", cWxBitmap.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxCursor, (void *) &cWxCursor);
    rb_define_alloc_func(cWxCursor.klass, _wrap_wxCursor_allocate);
    rb_define_method(cWxCursor.klass, "initialize", VALUEFUNC(_wrap_new_wxCursor), -1);
    rb_define_method(cWxCursor.klass, "ok", VALUEFUNC(_wrap_wxCursor_Ok), -1);
    cWxCursor.mark = 0;
    cWxCursor.destroy = (void (*)(void *)) free_wxCursor;
}
