...
#define SWIGTYPE_p_wxWindowDC swig_types[5]
...
#define SWIG_init    Init_wxWindowDC
#define SWIG_name    "WxWindowDC"

static VALUE mWxWindowDC;
...
SwigDirector_wxWindowDC::SwigDirector_wxWindowDC(VALUE self, wxWindow *window): wxWindowDC(window), Swig::Director(self) {
    
}



SwigDirector_wxWindowDC::~SwigDirector_wxWindowDC() {
}

extern swig_class cWxDC;
swig_class cWxWindowDC;

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
static VALUE
_wrap_wxWindowDC_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxWindowDC_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxWindowDC);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
_wrap_new_wxWindowDC(int argc, VALUE *argv, VALUE self) {
    ...
    char *classname = "WxWindowDC::WxWindowDC";
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxWindowDC *)new SwigDirector_wxWindowDC(arg1,arg2);
...
extern "C"
#endif
SWIGEXPORT void Init_wxWindowDC(void) {
...
mWxWindowDC = mWxruby2;
    ...
    Init_wxDC();
    //extern swig_class cWxDC;
    cWxWindowDC.klass = rb_define_class_under(mWxWindowDC, "WindowDC", cWxDC.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxWindowDC, (void *) &cWxWindowDC);
    rb_define_alloc_func(cWxWindowDC.klass, _wrap_wxWindowDC_allocate);
    rb_define_method(cWxWindowDC.klass, "initialize", VALUEFUNC(_wrap_new_wxWindowDC), -1);
    cWxWindowDC.mark = 0;
    cWxWindowDC.destroy = (void (*)(void *)) free_wxWindowDC;
}
