...
#define SWIGTYPE_p_wxFindDialogEvent swig_types[3]
...
#ifdef wxDEBUG
    printf("FindDialogEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("FindDialogEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
#include "FindDialogEvent.h"

extern swig_class cWxCommandEvent;
swig_class cWxFindDialogEvent;

static VALUE
_wrap_new_wxFindDialogEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    int arg2 ;
...
static VALUE
_wrap_new_wxFindDialogEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    wxFindDialogEvent *result;
    ...
    arg1 = NUM2INT(argv[0]);
    result = (wxFindDialogEvent *)new wxFindDialogEvent(arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxFindDialogEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxFindDialogEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxFindDialogEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxFindDialogEvent__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxFindDialogEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxFindDialogEvent *)new wxFindDialogEvent();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxFindDialogEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxFindDialogEvent__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxFindDialogEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxFindDialogEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxFindDialogEvent'");
    return Qnil;
}


static VALUE
_wrap_wxFindDialogEvent_GetFlags(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxFindDialogEvent, 1);
    result = (int)((wxFindDialogEvent const *)arg1)->GetFlags();
...
static VALUE
_wrap_wxFindDialogEvent_GetFindString(int argc, VALUE *argv, VALUE self) {
    wxFindDialogEvent *arg1 = (wxFindDialogEvent *) 0 ;
    wxString result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxFindDialogEvent_GetReplaceString(int argc, VALUE *argv, VALUE self) {
    wxFindDialogEvent *arg1 = (wxFindDialogEvent *) 0 ;
    wxString result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxFindDialogEvent_GetDialog(int argc, VALUE *argv, VALUE self) {
    wxFindDialogEvent *arg1 = (wxFindDialogEvent *) 0 ;
    ...
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxFindDialogEvent, 1);
    result = (wxFindReplaceDialog *)((wxFindDialogEvent const *)arg1)->GetDialog();
    
    vresult = SWIG_NewPointerObj((void *) result, SWIGTYPE_p_wxFindReplaceDialog,0);
    return vresult;
}


static void
free_wxFindDialogEvent(wxFindDialogEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxFindDialogEvent = {"_p_wxFindDialogEvent", "wxFindDialogEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxFindDialogEvent(void) {
...
mWxFindDialogEvent = mWxruby2;
    ...
    Init_wxCommandEvent();
    //extern swig_class cWxCommandEvent;
    cWxFindDialogEvent.klass = rb_define_class_under(mWxFindDialogEvent, "FindDialogEvent", cWxCommandEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxFindDialogEvent, (void *) &cWxFindDialogEvent);
    rb_define_alloc_func(cWxFindDialogEvent.klass, _wrap_wxFindDialogEvent_allocate);
    rb_define_method(cWxFindDialogEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxFindDialogEvent), -1);
    rb_define_method(cWxFindDialogEvent.klass, "get_flags", VALUEFUNC(_wrap_wxFindDialogEvent_GetFlags), -1);
    rb_define_method(cWxFindDialogEvent.klass, "get_find_string", VALUEFUNC(_wrap_wxFindDialogEvent_GetFindString), -1);
    rb_define_method(cWxFindDialogEvent.klass, "get_replace_string", VALUEFUNC(_wrap_wxFindDialogEvent_GetReplaceString), -1);
    rb_define_method(cWxFindDialogEvent.klass, "get_dialog", VALUEFUNC(_wrap_wxFindDialogEvent_GetDialog), -1);
    cWxFindDialogEvent.mark = 0;
    cWxFindDialogEvent.destroy = (void (*)(void *)) free_wxFindDialogEvent;
}
