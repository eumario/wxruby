...
#define  SWIGTYPE_p_wxBusyInfo swig_types[1] 
...
void wxBusyInfo_busy(char const *msg,wxWindow *parent){
    if (rb_block_given_p())
    {
...
static void free_wxBusyInfo(wxBusyInfo *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_wxBusyInfo_busy(int argc, VALUE *argv, VALUE self) {
    char *arg1 ;
    ...
    wxBusyInfo_busy((char const *)arg1,arg2);
