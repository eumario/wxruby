...
#define  SWIGTYPE_p_wxNotebookEvent swig_types[0] 
...
static void free_wxNotebookEvent(wxNotebookEvent *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_new_wxNotebookEvent(int argc, VALUE *argv, VALUE self) {
