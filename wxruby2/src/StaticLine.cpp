...
#define  SWIGTYPE_p_wxStaticLine swig_types[2] 
...
static void free_wxStaticLine(wxStaticLine *);
/***********************************************************************
 * director.swg
 *
...
_wrap_new_wxStaticLine__SWIG_1(int argc, VALUE *argv, VALUE self) {
    ...
    wxString const &arg6_defvalue = wxT("staticLine") ;
...
static VALUE
_wrap_wxStaticLine_Create(int argc, VALUE *argv, VALUE self) {
    ...
    long arg6 = (long) 0 ;
    wxString const &arg7_defvalue = wxT("staticLine") ;
