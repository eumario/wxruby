...
#define  SWIGTYPE_p_wxFocusEvent swig_types[0] 
...
static void free_wxFocusEvent(wxFocusEvent *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_new_wxFocusEvent(int argc, VALUE *argv, VALUE self) {
