...
#define  SWIGTYPE_p_wxFindReplaceDialog swig_types[0] 
#define  SWIGTYPE_p_wxFindReplaceData swig_types[1] 
...
static void free_wxFindReplaceDialog(wxFindReplaceDialog *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxFindReplaceDialog::SwigDirector_wxFindReplaceDialog(VALUE self, wxWindow *parent, wxFindReplaceData *data, wxString const &title, int style, bool disown): wxFindReplaceDialog(parent, data, title, style), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxFindReplaceDialog(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxFindReplaceDialog *)new SwigDirector_wxFindReplaceDialog(arg1,arg2,arg3,(wxString const &)*arg4,arg5,false);
...
static VALUE
_wrap_wxFindReplaceDialog_Create(int argc, VALUE *argv, VALUE self) {
