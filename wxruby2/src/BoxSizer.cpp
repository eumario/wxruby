...
#define SWIGTYPE_p_wxBoxSizer swig_types[3]
...
#define SWIG_init    Init_wxBoxSizer
#define SWIG_name    "WxBoxSizer"

static VALUE mWxBoxSizer;
...
SwigDirector_wxBoxSizer::SwigDirector_wxBoxSizer(VALUE self, int orient): wxBoxSizer(orient), Swig::Director(self) {
    
}



SwigDirector_wxBoxSizer::~SwigDirector_wxBoxSizer() {
}

extern swig_class cWxSizer;
swig_class cWxBoxSizer;
...
#else
    static VALUE
    _wrap_wxBoxSizer_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxBoxSizer);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
_wrap_new_wxBoxSizer(int argc, VALUE *argv, VALUE self) {
    ...
    arg1 = self;
    arg2 = NUM2INT(argv[0]);
    char *classname = "WxBoxSizer::WxBoxSizer";
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxBoxSizer *)new SwigDirector_wxBoxSizer(arg1,arg2);
...
static VALUE
_wrap_wxBoxSizer_RecalcSizes(int argc, VALUE *argv, VALUE self) {
    wxBoxSizer *arg1 = (wxBoxSizer *) 0 ;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxBoxSizer, 1);
    (arg1)->RecalcSizes();
...
static VALUE
_wrap_wxBoxSizer_CalcMin(int argc, VALUE *argv, VALUE self) {
    wxBoxSizer *arg1 = (wxBoxSizer *) 0 ;
    wxSize result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxBoxSizer_GetOrientation(int argc, VALUE *argv, VALUE self) {
    wxBoxSizer *arg1 = (wxBoxSizer *) 0 ;
    int result;
    VALUE vresult = Qnil;
...
static swig_type_info _swigt__p_wxBoxSizer = {"_p_wxBoxSizer", "wxBoxSizer *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxBoxSizer(void) {
...
mWxBoxSizer = mWxruby2;
    ...
    Init_wxSizer();
    //extern swig_class cWxSizer;
    cWxBoxSizer.klass = rb_define_class_under(mWxBoxSizer, "BoxSizer", cWxSizer.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxBoxSizer, (void *) &cWxBoxSizer);
    rb_define_alloc_func(cWxBoxSizer.klass, _wrap_wxBoxSizer_allocate);
    rb_define_method(cWxBoxSizer.klass, "initialize", VALUEFUNC(_wrap_new_wxBoxSizer), -1);
    rb_define_method(cWxBoxSizer.klass, "recalc_sizes", VALUEFUNC(_wrap_wxBoxSizer_RecalcSizes), -1);
    rb_define_method(cWxBoxSizer.klass, "calc_min", VALUEFUNC(_wrap_wxBoxSizer_CalcMin), -1);
    rb_define_method(cWxBoxSizer.klass, "get_orientation", VALUEFUNC(_wrap_wxBoxSizer_GetOrientation), -1);
    cWxBoxSizer.mark = 0;
    cWxBoxSizer.destroy = (void (*)(void *)) free_wxBoxSizer;
}
