...
public:
    SwigDirector_wxFrame(VALUE self, bool disown = 0);
    SwigDirector_wxFrame(VALUE self, wxWindow *parent, wxWindowID id, wxString const &title, wxPoint const &pos = wxDefaultPosition, wxSize const &size = wxDefaultSize, long style = wxDEFAULT_FRAME_STYLE, wxString const &name = "frame", bool disown = 0);
