...
#define SWIGTYPE_p_wxEventTable swig_types[5]
...
SwigDirector_wxEvtHandler::SwigDirector_wxEvtHandler(VALUE self): wxEvtHandler(), Swig::Director(self) {
    
}



SwigDirector_wxEvtHandler::~SwigDirector_wxEvtHandler() {
}
...
_wrap_new_wxEvtHandler(int argc, VALUE *argv, VALUE self) {
    ...
    arg1 = self;
    char *classname = "WxEvtHandler::WxEvtHandler";
    if ( strcmp(rb_obj_classname(self), classname) != 0 ) {
        /* subclassed */
        result = (wxEvtHandler *)new SwigDirector_wxEvtHandler(arg1);
...
static swig_type_info _swigt__p_wxEventTable = {"_p_wxEventTable", "wxEventTable *", 0, 0, 0};
...
static swig_cast_info _swigc__p_wxEventTable[] = {  {&_swigt__p_wxEventTable, 0, 0, 0},{0, 0, 0, 0}};
