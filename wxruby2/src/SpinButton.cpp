...
#define  SWIGTYPE_p_wxSpinButton swig_types[1] 
...
static void free_wxSpinButton(wxSpinButton *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxSpinButton::SwigDirector_wxSpinButton(VALUE self, wxWindow *parent, wxWindowID id, wxPoint const &pos, wxSize const &size, long style, wxString const &name, bool disown): wxSpinButton(parent, id, pos, size, style, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxSpinButton(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxSpinButton *)new SwigDirector_wxSpinButton(arg1,arg2,arg3,(wxPoint const &)*arg4,(wxSize const &)*arg5,arg6,(wxString const &)*arg7,false);
...
static VALUE
_wrap_wxSpinButton_Create(int argc, VALUE *argv, VALUE self) {
