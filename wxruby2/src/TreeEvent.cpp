...
#define SWIGTYPE_p_wxTreeEvent swig_types[5]
#define SWIGTYPE_p_wxTreeItemId swig_types[6]
...
#ifdef wxDEBUG
    printf("TreeEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("TreeEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxTreeEvent;

static VALUE
_wrap_new_wxTreeEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    WXTYPE arg1 ;
    int arg2 ;
    wxTreeEvent *result;
...
static VALUE
_wrap_new_wxTreeEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    WXTYPE arg1 ;
    wxTreeEvent *result;
...
static VALUE
_wrap_wxTreeEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxTreeEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxTreeEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxTreeEvent__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxTreeEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxTreeEvent *)new wxTreeEvent();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxTreeEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxTreeEvent__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
    ...
    if (argc == 2) {
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxTreeEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxTreeEvent'");
    return Qnil;
}


static VALUE
_wrap_wxTreeEvent_GetKeyCode(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxTreeEvent, 1);
...
static VALUE
_wrap_wxTreeEvent_GetItem(int argc, VALUE *argv, VALUE self) {
    wxTreeEvent *arg1 = (wxTreeEvent *) 0 ;
    wxTreeItemId result;
    VALUE vresult = Qnil;
    ...
    
    {
        ...
        vresult = SWIG_NewPointerObj((void *) resultptr, SWIGTYPE_p_wxTreeItemId, 1);
    }
    return vresult;
}
...
static VALUE
_wrap_wxTreeEvent_GetKeyEvent(int argc, VALUE *argv, VALUE self) {
    wxTreeEvent *arg1 = (wxTreeEvent *) 0 ;
    wxKeyEvent *result;
    VALUE vresult = Qnil;
    ...
    vresult = SWIG_NewPointerObj((void *) result, SWIGTYPE_p_wxKeyEvent,0);
    return vresult;
}


static VALUE
_wrap_wxTreeEvent_GetOldItem(int argc, VALUE *argv, VALUE self) {
    wxTreeEvent *arg1 = (wxTreeEvent *) 0 ;
    wxTreeItemId result;
    VALUE vresult = Qnil;
...
static void
free_wxTreeEvent(wxTreeEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxTreeEvent = {"_p_wxTreeEvent", "wxTreeEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxTreeEvent(void) {
...
mWxTreeEvent = mWxruby2;
    ...
    Init_wxNotifyEvent();
    //extern swig_class cWxNotifyEvent;
    cWxTreeEvent.klass = rb_define_class_under(mWxTreeEvent, "TreeEvent", cWxNotifyEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxTreeEvent, (void *) &cWxTreeEvent);
    rb_define_alloc_func(cWxTreeEvent.klass, _wrap_wxTreeEvent_allocate);
    rb_define_method(cWxTreeEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxTreeEvent), -1);
    rb_define_method(cWxTreeEvent.klass, "get_key_code", VALUEFUNC(_wrap_wxTreeEvent_GetKeyCode), -1);
    rb_define_method(cWxTreeEvent.klass, "get_item", VALUEFUNC(_wrap_wxTreeEvent_GetItem), -1);
    rb_define_method(cWxTreeEvent.klass, "get_key_event", VALUEFUNC(_wrap_wxTreeEvent_GetKeyEvent), -1);
    rb_define_method(cWxTreeEvent.klass, "get_old_item", VALUEFUNC(_wrap_wxTreeEvent_GetOldItem), -1);
    cWxTreeEvent.mark = 0;
    cWxTreeEvent.destroy = (void (*)(void *)) free_wxTreeEvent;
}
