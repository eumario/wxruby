...
#define SWIGTYPE_p_wxSplitterWindow swig_types[4]
...
#ifdef wxDEBUG
    printf("SplitterEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("SplitterEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
#include "SplitterEvent.h"

extern swig_class cWxNotifyEvent;
swig_class cWxSplitterEvent;

static VALUE
_wrap_new_wxSplitterEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    wxSplitterWindow *arg2 = (wxSplitterWindow *) 0 ;
...
static VALUE
_wrap_new_wxSplitterEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxEventType arg1 ;
    wxSplitterEvent *result;
    ...
    arg1 = NUM2INT(argv[0]);
    result = (wxSplitterEvent *)new wxSplitterEvent(arg1);
    DATA_PTR(self) = result;
    return self;
}
...
static VALUE
_wrap_wxSplitterEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxSplitterEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxSplitterEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxSplitterEvent__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxSplitterEvent *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxSplitterEvent *)new wxSplitterEvent();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxSplitterEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxSplitterEvent__SWIG_2(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxSplitterEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            {
                void *ptr;
                _v = (NIL_P(argv[1]) || (TYPE(argv[1]) == T_DATA && SWIG_ConvertPtr(argv[1], &ptr, SWIGTYPE_p_wxSplitterWindow, 0) != -1)) ? 1 : 0;
            }
            if (_v) {
                return _wrap_new_wxSplitterEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxSplitterEvent'");
    return Qnil;
}


static VALUE
_wrap_wxSplitterEvent_GetSashPosition(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxSplitterEvent, 1);
...
static VALUE
_wrap_wxSplitterEvent_GetX(int argc, VALUE *argv, VALUE self) {
    wxSplitterEvent *arg1 = (wxSplitterEvent *) 0 ;
    int result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxSplitterEvent_GetY(int argc, VALUE *argv, VALUE self) {
    wxSplitterEvent *arg1 = (wxSplitterEvent *) 0 ;
    int result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxSplitterEvent_GetWindowBeingRemoved(int argc, VALUE *argv, VALUE self) {
    wxSplitterEvent *arg1 = (wxSplitterEvent *) 0 ;
    wxWindow *result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxSplitterEvent_SetSashPosition(int argc, VALUE *argv, VALUE self) {
    wxSplitterEvent *arg1 = (wxSplitterEvent *) 0 ;
    int arg2 ;
...
static void
free_wxSplitterEvent(wxSplitterEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxSplitterEvent = {"_p_wxSplitterEvent", "wxSplitterEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxSplitterEvent(void) {
...
mWxSplitterEvent = mWxruby2;
    ...
    Init_wxNotifyEvent();
    //extern swig_class cWxNotifyEvent;
    cWxSplitterEvent.klass = rb_define_class_under(mWxSplitterEvent, "SplitterEvent", cWxNotifyEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxSplitterEvent, (void *) &cWxSplitterEvent);
    rb_define_alloc_func(cWxSplitterEvent.klass, _wrap_wxSplitterEvent_allocate);
    rb_define_method(cWxSplitterEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxSplitterEvent), -1);
    rb_define_method(cWxSplitterEvent.klass, "get_sash_position", VALUEFUNC(_wrap_wxSplitterEvent_GetSashPosition), -1);
    rb_define_method(cWxSplitterEvent.klass, "get_x", VALUEFUNC(_wrap_wxSplitterEvent_GetX), -1);
    rb_define_method(cWxSplitterEvent.klass, "get_y", VALUEFUNC(_wrap_wxSplitterEvent_GetY), -1);
    rb_define_method(cWxSplitterEvent.klass, "get_window_being_removed", VALUEFUNC(_wrap_wxSplitterEvent_GetWindowBeingRemoved), -1);
    rb_define_method(cWxSplitterEvent.klass, "set_sash_position", VALUEFUNC(_wrap_wxSplitterEvent_SetSashPosition), -1);
    cWxSplitterEvent.mark = 0;
    cWxSplitterEvent.destroy = (void (*)(void *)) free_wxSplitterEvent;
}
