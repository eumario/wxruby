...
#define SWIGTYPE_p_wxCaret swig_types[2]
...
#define SWIGTYPE_p_wxWindowBase swig_types[7]
...
static VALUE
_wrap_new_wxCaret(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_wxCaret_MoveXy(int argc, VALUE *argv, VALUE self) {
    wxCaret *arg1 = (wxCaret *) 0 ;
    int arg2 ;
    int arg3 ;
...
static VALUE
_wrap_wxCaret_Move(int argc, VALUE *argv, VALUE self) {
    wxCaret *arg1 = (wxCaret *) 0 ;
    wxPoint *arg2 = 0 ;
...
static VALUE
_wrap_wxCaret_Show__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxCaret *arg1 = (wxCaret *) 0 ;
    bool arg2 ;
...
static VALUE
_wrap_wxCaret_Show__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxCaret *arg1 = (wxCaret *) 0 ;
...
static VALUE _wrap_wxCaret_Show(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[3];
    int ii;
    ...
    if (argc == 1) {
        ...
        if (_v) {
            return _wrap_wxCaret_Show__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_wxCaret_Show__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxCaret_Show'");
    return Qnil;
}
...
static swig_type_info _swigt__p_wxWindowBase = {"_p_wxWindowBase", "wxWindowBase *", 0, 0, 0};
