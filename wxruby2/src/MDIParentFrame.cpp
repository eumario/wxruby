...
#define  SWIGTYPE_p_wxMDIChildFrame swig_types[0] 
...
static void free_wxMDIParentFrame(wxMDIParentFrame *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxMDIParentFrame::SwigDirector_wxMDIParentFrame(VALUE self, wxWindow *parent, wxWindowID id, wxString const &title, wxPoint const &pos, wxSize const &size, long style, wxString const &name, bool disown): wxMDIParentFrame(parent, id, title, pos, size, style, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxMDIParentFrame(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxMDIParentFrame *)new SwigDirector_wxMDIParentFrame(arg1,arg2,arg3,(wxString const &)*arg4,(wxPoint const &)*arg5,(wxSize const &)*arg6,arg7,(wxString const &)*arg8,false);
...
static VALUE
_wrap_wxMDIParentFrame_Create(int argc, VALUE *argv, VALUE self) {
    wxMDIParentFrame *arg1 = (wxMDIParentFrame *) 0 ;
    wxWindow *arg2 = (wxWindow *) 0 ;
    wxWindowID arg3 ;
    wxString *arg4 = 0 ;
