...
#define SWIGTYPE_p_wxSizeEvent swig_types[4]
...
#define SWIG_init    Init_wxSizeEvent
#define SWIG_name    "WxSizeEvent"

static VALUE mWxSizeEvent;
...
#ifdef wxDEBUG
    printf("SizeEvent.cpp" " new Director %p\n", this);
    fflush(stdout);
#endif
...
#ifdef wxDEBUG
    printf("SizeEvent.cpp" " ~Director %p\n", this);
    fflush(stdout);
#endif
    GcMarkDeleted(this);
      }
...
swig_class cWxSizeEvent;

static VALUE
_wrap_new_wxSizeEvent__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = 0 ;
    int arg2 ;
    wxSizeEvent *result;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxSize, 1); if (arg1 == NULL) rb_raise(rb_eTypeError, "null reference");
    arg2 = NUM2INT(argv[1]);
...
static VALUE
_wrap_wxSizeEvent_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxSizeEvent_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxSizeEvent);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxSizeEvent__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = 0 ;
    wxSizeEvent *result;
    ...
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxSize, 1); if (arg1 == NULL) rb_raise(rb_eTypeError, "null reference");
    result = (wxSizeEvent *)new wxSizeEvent((wxSize const &)*arg1);
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxSizeEvent(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[2];
    int ii;
    ...
    if (argc == 1) {
        ...
        {
            void *ptr;
            _v = (NIL_P(argv[0]) || (TYPE(argv[0]) == T_DATA && SWIG_ConvertPtr(argv[0], &ptr, SWIGTYPE_p_wxSize, 0) != -1)) ? 1 : 0;
        }
        if (_v) {
            return _wrap_new_wxSizeEvent__SWIG_1(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_new_wxSizeEvent__SWIG_0(nargs, args, self);
            }
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxSizeEvent'");
    return Qnil;
}


static VALUE
_wrap_wxSizeEvent_GetSize(int argc, VALUE *argv, VALUE self) {
    ...
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_wxSizeEvent, 1);
...
static void
free_wxSizeEvent(wxSizeEvent *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_wxSizeEvent = {"_p_wxSizeEvent", "wxSizeEvent *", 0, 0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_wxSizeEvent(void) {
...
mWxSizeEvent = mWxruby2;
    ...
    Init_wxEvent();
    //extern swig_class cWxEvent;
    cWxSizeEvent.klass = rb_define_class_under(mWxSizeEvent, "SizeEvent", cWxEvent.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxSizeEvent, (void *) &cWxSizeEvent);
    rb_define_alloc_func(cWxSizeEvent.klass, _wrap_wxSizeEvent_allocate);
    rb_define_method(cWxSizeEvent.klass, "initialize", VALUEFUNC(_wrap_new_wxSizeEvent), -1);
    rb_define_method(cWxSizeEvent.klass, "get_size", VALUEFUNC(_wrap_wxSizeEvent_GetSize), -1);
    cWxSizeEvent.mark = 0;
    cWxSizeEvent.destroy = (void (*)(void *)) free_wxSizeEvent;
}
