...
#define  SWIGTYPE_p_wxSizeEvent swig_types[0] 
...
static void free_wxSizeEvent(wxSizeEvent *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_new_wxSizeEvent(int argc, VALUE *argv, VALUE self) {
    wxSize *arg1 = 0 ;
    int arg2 = (int) 0 ;
    wxSizeEvent *result;
