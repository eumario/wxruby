...
static void free_wxStaticBox(wxStaticBox *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxStaticBox::SwigDirector_wxStaticBox(VALUE self, wxWindow *parent, wxWindowID id, wxString const &label, wxPoint const &pos, wxSize const &size, long style, wxString const &name, bool disown): wxStaticBox(parent, id, label, pos, size, style, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxStaticBox(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxStaticBox *)new SwigDirector_wxStaticBox(arg1,arg2,arg3,(wxString const &)*arg4,(wxPoint const &)*arg5,(wxSize const &)*arg6,arg7,(wxString const &)*arg8,false);
...
static VALUE
_wrap_wxStaticBox_Create(int argc, VALUE *argv, VALUE self) {
