...
#define  SWIGTYPE_p_wxGauge swig_types[0] 
...
swig_class cWxGauge;
static void free_wxGauge(wxGauge *);
/***********************************************************************
 * director.swg
 *
...
SwigDirector_wxGauge::SwigDirector_wxGauge(VALUE self, wxWindow *parent, wxWindowID id, int range, wxPoint const &pos, wxSize const &size, long style, wxValidator const &validator, wxString const &name, bool disown): wxGauge(parent, id, range, pos, size, style, validator, name), Swig::Director(self, disown) {
...
static VALUE
_wrap_new_wxGauge(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxGauge *)new SwigDirector_wxGauge(arg1,arg2,arg3,arg4,(wxPoint const &)*arg5,(wxSize const &)*arg6,arg7,(wxValidator const &)*arg8,(wxString const &)*arg9,false);
...
static VALUE
_wrap_wxGauge_Create(int argc, VALUE *argv, VALUE self) {
