...
#define  SWIGTYPE_p_wxCursor swig_types[0] 
#define  SWIGTYPE_p_wxBusyCursor swig_types[1] 
...
swig_class cWxBusyCursor;
static void free_wxBusyCursor(wxBusyCursor *);
/***********************************************************************
 * director.swg
 *
...
static VALUE
_wrap_wxBusyCursor_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxBusyCursor_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxBusyCursor);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxBusyCursor(int argc, VALUE *argv, VALUE self) {
    VALUE arg1 ;
    wxCursor *arg2 = (wxCursor *) wxHOURGLASS_CURSOR ;
    wxBusyCursor *result;
    ...
    arg1 = self;
    if (argc > 0) {
        SWIG_ConvertPtr(argv[0], (void **) &arg2, SWIGTYPE_p_wxCursor, 1);
    }
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxBusyCursor *)new SwigDirector_wxBusyCursor(arg1,arg2,false);
        
    } else {
        result = (wxBusyCursor *)new wxBusyCursor(arg2);
...
static VALUE
_wrap_wxBusyCursor_busy(int argc, VALUE *argv, VALUE self) {
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    wxBusyCursor_busy();
...
static VALUE
_wrap_disown_wxBusyCursor(int argc, VALUE *argv, VALUE self) {
    wxBusyCursor *arg1 = (wxBusyCursor *) 0 ;
    
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_wxBusyCursor, 1);
    {
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxBusyCursor(void) {
...
mWxBusyCursor = mWxruby2;
    ...
    rb_define_module_function(mWxBusyCursor, "disown_wxBusyCursor", VALUEFUNC(_wrap_disown_wxBusyCursor), -1);
    
    cWxBusyCursor.klass = rb_define_class_under(mWxBusyCursor, "BusyCursor", rb_cObject);
    SWIG_TypeClientData(SWIGTYPE_p_wxBusyCursor, (void *) &cWxBusyCursor);
    rb_define_alloc_func(cWxBusyCursor.klass, _wrap_wxBusyCursor_allocate);
    rb_define_method(cWxBusyCursor.klass, "initialize", VALUEFUNC(_wrap_new_wxBusyCursor), -1);
    rb_define_singleton_method(cWxBusyCursor.klass, "busy", VALUEFUNC(_wrap_wxBusyCursor_busy), -1);
    cWxBusyCursor.mark = 0;
    cWxBusyCursor.destroy = (void (*)(void *)) free_wxBusyCursor;
}
