...
#define SWIGTYPE_p_wxBusyCursor swig_types[2]
...
static VALUE
_wrap_new_wxBusyCursor__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
static VALUE
_wrap_new_wxBusyCursor__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxBusyCursor *result;
    
    if ((argc < 0) || (argc > 0))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc);
    result = (wxBusyCursor *)new wxBusyCursor();
    DATA_PTR(self) = result;
    return self;
}


static VALUE _wrap_new_wxBusyCursor(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[1];
    int ii;
    ...
    if (argc == 0) {
        return _wrap_new_wxBusyCursor__SWIG_1(nargs, args, self);
    }
    if (argc == 1) {
        int _v;
        {
        ...
        if (_v) {
            return _wrap_new_wxBusyCursor__SWIG_0(nargs, args, self);
        }
    }
    
    rb_raise(rb_eArgError, "No matching function for overloaded 'new_wxBusyCursor'");
    return Qnil;
}
