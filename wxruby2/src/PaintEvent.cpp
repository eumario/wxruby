...
#define  SWIGTYPE_p_wxPaintEvent swig_types[0] 
...
static void free_wxPaintEvent(wxPaintEvent *);
/***********************************************************************
 * director.swg
 *
...
_wrap_new_wxPaintEvent(int argc, VALUE *argv, VALUE self) {
    ...
    if ( CLASS_OF(self) != Qnil ) {
        /* subclassed */
        result = (wxPaintEvent *)new SwigDirector_wxPaintEvent(arg1,arg2,false);
