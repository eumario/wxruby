...
#define  SWIGTYPE_p_wxGridCellBoolEditor swig_types[0] 
...
swig_class cWxGridCellBoolEditor;
static void free_wxGridCellBoolEditor(wxGridCellBoolEditor *);
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
static VALUE
_wrap_wxGridCellBoolEditor_allocate(VALUE self) {
#else
    static VALUE
    _wrap_wxGridCellBoolEditor_allocate(int argc, VALUE *argv, VALUE self) {
#endif
        
        
        VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_wxGridCellBoolEditor);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
static VALUE
_wrap_new_wxGridCellBoolEditor(int argc, VALUE *argv, VALUE self) {
...
static void
free_wxGridCellBoolEditor(wxGridCellBoolEditor *arg1) {
    //delete arg1;
}
...
extern "C"
#endif
SWIGEXPORT(void) Init_wxGridCellBoolEditor(void) {
...
initialized = true;
    ...
    SWIG_InitRuntime();
mWxGridCellBoolEditor = mWxruby2;
    ...
    //extern swig_class cWxGridCellEditor;
    cWxGridCellBoolEditor.klass = rb_define_class_under(mWxGridCellBoolEditor, "GridCellBoolEditor", cWxGridCellEditor.klass);
    SWIG_TypeClientData(SWIGTYPE_p_wxGridCellBoolEditor, (void *) &cWxGridCellBoolEditor);
    rb_define_alloc_func(cWxGridCellBoolEditor.klass, _wrap_wxGridCellBoolEditor_allocate);
    rb_define_method(cWxGridCellBoolEditor.klass, "initialize", VALUEFUNC(_wrap_new_wxGridCellBoolEditor), -1);
    cWxGridCellBoolEditor.mark = 0;
    cWxGridCellBoolEditor.destroy = (void (*)(void *)) free_wxGridCellBoolEditor;
}
