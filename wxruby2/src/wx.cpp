...
static VALUE
_wrap_wxMessageBox__SWIG_0(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    wxString *arg2 = 0 ;
    int arg3 ;
...
static VALUE
_wrap_wxMessageBox__SWIG_1(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    wxString *arg2 = 0 ;
    int arg3 ;
    wxWindow *arg4 = (wxWindow *) 0 ;
...
static VALUE
_wrap_wxMessageBox__SWIG_2(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    wxString *arg2 = 0 ;
    int arg3 ;
    wxWindow *arg4 = (wxWindow *) 0 ;
...
static VALUE
_wrap_wxMessageBox__SWIG_3(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    wxString *arg2 = 0 ;
    int arg3 ;
    int result;
...
static VALUE
_wrap_wxMessageBox__SWIG_4(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    wxString *arg2 = 0 ;
    int result;
    VALUE vresult = Qnil;
...
static VALUE
_wrap_wxMessageBox__SWIG_5(int argc, VALUE *argv, VALUE self) {
    wxString *arg1 = 0 ;
    int result;
    VALUE vresult = Qnil;
...
static VALUE _wrap_wxMessageBox(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[6];
    int ii;
    ...
    if (argc == 1) {
        ...
        if (_v) {
            return _wrap_wxMessageBox__SWIG_5(nargs, args, self);
        }
    }
    if (argc == 2) {
        int _v;
        ...
        if (_v) {
            ...
            if (_v) {
                return _wrap_wxMessageBox__SWIG_4(nargs, args, self);
            }
        }
    }
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_wxMessageBox__SWIG_3(nargs, args, self);
                }
            }
        }
    }
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        return _wrap_wxMessageBox__SWIG_2(nargs, args, self);
                    }
                }
            }
        }
            ...
            if (_v) {
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            return _wrap_wxMessageBox__SWIG_1(nargs, args, self);
                        }
                    }
                }
            }
                ...
                if (_v) {
                    ...
                    if (_v) {
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_wxMessageBox__SWIG_0(nargs, args, self);
                            }
                        }
                    }
                }
    ...
    rb_raise(rb_eArgError, "No matching function for overloaded 'wxMessageBox'");
    return Qnil;
}
...
extern "C" void InitializeOtherModules()
{
    ...
    Init_wxCheckBox();
    extern void Init_wxCheckListBox();
    Init_wxCheckListBox();
    ...
    extern void Init_wxCursor();
    Init_wxCursor();
    extern void Init_wxDC();
    Init_wxDC();
    extern void Init_wxDialog();
    Init_wxDialog();
    extern void Init_wxDirDialog();
    Init_wxDirDialog();
    ...
    Init_wxGrid();
    extern void Init_wxGridCellBoolEditor();
    Init_wxGridCellBoolEditor();
    extern void Init_wxGridCellChoiceEditor();
    Init_wxGridCellChoiceEditor();
    extern void Init_wxGridCellEditor();
    Init_wxGridCellEditor();
    extern void Init_wxGridCellFloatEditor();
    Init_wxGridCellFloatEditor();
    extern void Init_wxGridCellNumberEditor();
    Init_wxGridCellNumberEditor();
    extern void Init_wxGridCellTextEditor();
    Init_wxGridCellTextEditor();
    extern void Init_wxGridEvent();
    Init_wxGridEvent();
    extern void Init_wxGridRangeSelectEvent();
    Init_wxGridRangeSelectEvent();
    extern void Init_wxGridSizeEvent();
    Init_wxGridSizeEvent();
    ...
    Init_wxSpinEvent();
    extern void Init_wxSplitterEvent();
    Init_wxSplitterEvent();
    ...
    Init_wxXmlResource();
    extern void Init_wxEvents();
    Init_wxEvents();
    extern void Init_wxEvents2();
    Init_wxEvents2();
