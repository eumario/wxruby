...
#    delete @m_notebook.GetImageList()
    ...
    def initialize(frame,x,y,w,h)
        ...
        imagelist.add_icon( Icon.new( "icons/list.xpm" ))
        imagelist.add_icon( Icon.new( "icons/choice.xpm" ))
        imagelist.add_icon( Icon.new( "icons/combo.xpm" ))
        imagelist.add_icon( Icon.new( "icons/text.xpm" ))
        imagelist.add_icon( Icon.new( "icons/radio.xpm" ))
        imagelist.add_icon( Icon.new( "icons/gauge.xpm" ))
